    ...
    option = {
        baseOption: {
            timeline: {
                ...
                // },
                data: [
                    '北京区域','成渝区域','广州福建','联营区域','上海区域', '总部深圳区域'
        ...
        options: [
            {
                ...
                series: [
                    ...
                    {data: [
                        {name: '需求', value: dataMap.dataPI['2002sum']},
                        {name: 'BUG', value: dataMap.dataSI['2002sum']},
                        {name: '升级', value: dataMap.dataTI['2002sum']}
                    ]}
                ]
            },
            {
                ...
                series : [
                    ...
                    {data: [
                        {name: '需求', value: dataMap.dataPI['2003sum']},
                        {name: 'BUG', value: dataMap.dataSI['2003sum']},
                        {name: '升级', value: dataMap.dataTI['2003sum']}
                    ]}
                ]
            },
            {
                ...
                series : [
                    ...
                    {data: [
                        {name: '需求', value: dataMap.dataPI['2004sum']},
                        {name: 'BUG', value: dataMap.dataSI['2004sum']},
                        {name: '升级', value: dataMap.dataTI['2004sum']}
                    ]}
                ]
            },
            {
                ...
                series : [
                    ...
                    {data: [
                        {name: '需求', value: dataMap.dataPI['2005sum']},
                        {name: 'BUG', value: dataMap.dataSI['2005sum']},
                        {name: '升级', value: dataMap.dataTI['2005sum']}
                    ]}
                ]
            },
            {
                ...
                series : [
                    ...
                    {data: [
                        {name: '需求', value: dataMap.dataPI['2006sum']},
                        {name: 'BUG', value: dataMap.dataSI['2006sum']},
                        {name: '升级', value: dataMap.dataTI['2006sum']}
                    ]}
                ]
            },
            {
                ...
                series : [
                    ...
                    {data: [
                        {name: '需求', value: dataMap.dataPI['2007sum']},
                        {name: 'BUG', value: dataMap.dataSI['2007sum']},
                        {name: '升级', value: dataMap.dataTI['2007sum']}
                    ]}
                ]
            },
            {
                ...
                series : [
                    ...
                    {data: [
                        {name: '需求', value: dataMap.dataPI['2008sum']},
                        {name: 'BUG', value: dataMap.dataSI['2008sum']},
                        {name: '升级', value: dataMap.dataTI['2008sum']}
                    ]}
                ]
            },
            {
                ...
                series : [
                    ...
                    {data: [
                        {name: '需求', value: dataMap.dataPI['2009sum']},
                        {name: 'BUG', value: dataMap.dataSI['2009sum']},
                        {name: '升级', value: dataMap.dataTI['2009sum']}
                    ]}
                ]
            },
            {
                ...
                series : [
                    ...
                    {data: [
                        {name: '需求', value: dataMap.dataPI['2010sum']},
                        {name: 'BUG', value: dataMap.dataSI['2010sum']},
                        {name: '升级', value: dataMap.dataTI['2010sum']}
                    ]}
                ]
            },
            {
                ...
                series : [
                    ...
                    {data: [
                        {name: '需求', value: dataMap.dataPI['2011sum']},
                        {name: 'BUG', value: dataMap.dataSI['2011sum']},
                        {name: '升级', value: dataMap.dataTI['2011sum']}
                    ]}
                ]
            }
        ]
